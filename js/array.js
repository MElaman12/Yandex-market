...
let creat_fridge_block = () => {
    for(let item of fridge_arr){
    ...
    let block_top_h3 = document.createElement('h3')
        block_top_h3.innerText = item.name

    let block_top_item = document.createElement('div')
        block_top_item.classList.add('item')

    let block_top_item_span = document.createElement('div')
        block_top_item_span.classList.add('span')

    let item_span_span = document.createElement('span')
        item_span_span.classList.add('span1')

    let item_span_span2 = document.createElement('div')
        item_span_span2.classList.add('span2')
    
    let item_span_span2_span3 = document.createElement('span')
        item_span_span2_span3.classList.add('span1')
    
    let block_top_item_bottom = document.createElement('div')
        block_top_item_bottom.classList.add('bottom') 
    
    let item_bottom_span3 = document.createElement('span')
        item_bottom_span3.classList.add('span3')  
    
    let bottom_img = document.createElement('img')
        bottom_img.classList.add('heart')
        bottom_img.setAttribute('src', '../images/heart_inactive.png')
    
    let bottom_img2 = document.createElement('img')
        bottom_img2.setAttribute('src', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1JwbsZon6NA470fhEUGeWjX9U5ADkJss4Jw&usqp=CAU')    

    block.append(block_top)
    block_top.append(block_top_h3)
    block.append(block_top_item)
    block_top_item.append(block_top_item_span)
    block_top_item_span.append(item_span_span)
    block_top_item.append(item_span_span2)
    item_span_span2.append(item_span_span2_span3)

    block.append(block_top_item_bottom)
    block_top_item_bottom.append(item_bottom_span3)
    block_top_item_bottom.append(bottom_img)
    block_top_item_bottom.append(bottom_img2)
    }
}

box.append(creat_fridge_block())
...
<div class="item">
    <div class="span">
        <span class="span1">С гаринтией</span>
    </div>
    <div class="span2">
        <span class="span3">$1299</span>
    </div>
</div>
</div>

<div class="bottom">
<span class="span3">Добавить в корзину</span>
<img class="heart" src="../images/heart_inactive.png">
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1JwbsZon6NA470fhEUGeWjX9U5ADkJss4Jw&usqp=CAU" >
</div>
</div> */}