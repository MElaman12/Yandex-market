    ...
    let h3 = document.querySelectorAll('.block .top h3')
        h3[0].textContent = laptop_arr[0].name
        h3[1].textContent = laptop_arr[1].name
        h3[2].textContent = laptop_arr[2].name
        h3[3].textContent = laptop_arr[3].name
        h3[4].textContent = laptop_arr[4].name
    // ------------------------


    // ------------------------
    let balance = document.querySelectorAll('.balance')  
        balance[0].innerText = laptop_arr[0].price + '$'
        balance[1].innerText = laptop_arr[1].price + '$'
        balance[2].innerText = laptop_arr[2].price + '$'
        balance[3].innerText = laptop_arr[3].price + '$'
        balance[4].innerText = laptop_arr[4].price + '$'
    // ------------------------
    ...
    add[0].onclick = () => {
        ...
        let a = (laptop_arr[0].price / 100 * laptop_arr[0].cashback) * object_quantity.textContent 
        let b = (laptop_arr[1].price / 100 * laptop_arr[1].cashback) * object_quantity1.textContent 
        let c = (laptop_arr[2].price / 100 * laptop_arr[2].cashback) * object_quantity2.textContent
        let d = (laptop_arr[3].price / 100 * laptop_arr[3].cashback) * object_quantity3.textContent
        let e = (laptop_arr[4].price / 100 * laptop_arr[4].cashback) * object_quantity4.textContent 

        total.innerHTML = 'Общий чек: ' + '<span class="cash">' + Number((object_quantity.textContent * laptop_arr[0].price) + (object_quantity1.textContent * laptop_arr[1].price) + (object_quantity2.textContent * laptop_arr[2].price) + (object_quantity3.textContent * laptop_arr[3].price) + (object_quantity4.textContent * laptop_arr[4].price)) + '$' + '</span>'  
    ...
    total.textContent = 'Общий чек: ' + Number((object_quantity.textContent * laptop_arr[0].price) + (object_quantity1.textContent * laptop_arr[1].price) + (object_quantity2.textContent * laptop_arr[2].price) + (object_quantity3.textContent * laptop_arr[3].price) + (object_quantity4.textContent * laptop_arr[4].price)) + '$'
    ...
    total.textContent = 'Общий чек: ' + Number((object_quantity.textContent * laptop_arr[0].price) + (object_quantity1.textContent * laptop_arr[1].price) + (object_quantity2.textContent * laptop_arr[2].price) + 
    (object_quantity3.textContent * laptop_arr[3].price) + (object_quantity4.textContent * laptop_arr[4].price)) + '$'
